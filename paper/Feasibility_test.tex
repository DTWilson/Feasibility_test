...
% Up to 5 keywords
\keywords{Pilot trial, external pilot, feasibility, sample size, progression criteria}
...
%When comparing our procedure with a more conventional approach to making progression decisions, we found the latter to be considerably less efficient and, in some cases, worse than a completely random decision 
