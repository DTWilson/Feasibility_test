...
{
  opt_a <- optim(c(0.9,0.9), fn=get_oc2,
                 c=c, n=n, xi=x0, a=T, mu=mu, n_e=n_e, n_t=n_t)
  
  opt_b <- optim(c(0.9,0.9), fn=get_oc2,
...
get_ocs_pc <- function(cs, n, x0, x1, n_e, n_t)
{
  ...
  # Locally optimise 
  opt_a <- optim(c(0.9,0.9), fn=get_oc_pc,
                 cs=cs, n=n, xi=x0, tI=T, s=s, f=f, a=a, n_e=n_e, n_t=n_t)
    
  opt_b <- optim(c(0.9,0.9), fn=get_oc_pc,
                 cs=cs, n=n, xi=x1, tI=F, s=s, f=f, a=a, n_e=n_e, n_t=n_t)

  c(-opt_a$value, 1-opt_b$value)
}

# For example,
get_ocs_pc(rep(0.5, 3), 30, x0, x1, n_e=1000, n_t=514)
```
